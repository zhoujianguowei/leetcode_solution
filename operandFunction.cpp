...
void nextPermutation(vector<int>& nums)
{
	...
	for (i = 0; i < (signed)nums.size() - 1; i++)
	...
	else
	{
		...
		for (int j = minIndex + 2; j <(signed)nums.size(); j++)
...
/*
extended Euclidean algorithm,such as ax+by=c
*/
string extendedEuclideanExpression(int a, int b)
{
	return "";
}
/*
